...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture,overlay,anchor=north west,align=left]
        ...
        \begin{scope}
            ...
            \node[anchor=center, xshift=0.5*\sidebarwidth, yshift=-0.5*\sidebarwidth] at (current page.north west) (photo) {\includegraphics[width=\picturewidth]{profile_sq.jpg}};
        ...
        % Technical skills
        \node[skills node, yshift=-2.5em] at (sidebarleft |- photo.south west) (techskills) {
        ...
        \node[anchor=west, align=left] at (photo.east -| bodyleft) (headline) {
            \Huge \textcolor{accentcolour}{\textbf{Aaron Hurst}} \\[0.5em]
        ...
        \node[body node] at (profile.south west) (profilebody) {
...
%            He holds BSc (2016) and Masters (2018) degrees in electronic engineering from The University of Western Australia, together with a PhD from Aarhus University (2024).
        ...
        \node[body node] at (experience.south west) (e1) {
            ...
            \begin{itemize}[itemsep=-1pt,topsep=0.4em]
                ...
                \item Leading collaborations with Aarhus University of Biology and Villanova University.
            \end{itemize}
        };
        \node[body node, yshift=-0.6em] at (e1.south west) (e2) {
        ...
        \node[body node, yshift=-0.6em] at (e2.south west) (e3) {
    ...
    \begin{tikzpicture}[remember picture,overlay,anchor=north west,align=left]
            ...
            % Publications
            \node[skills node, text width=5.4cm, anchor=west] at (sidebarleft |- current page.west) (publications) {
        ...
        \node[body node, yshift=-0.6em] at (e2.south west) (e2) {
        ...
        \node[header node] at (e2.south west) (aboutme) {\Large\textbf{About Me}};
        \draw[header line] (aboutme.east)+(0.5em,0) -- (aboutme -| bodyright)+(-2cm,0);
        \node[body node] at (aboutme.south west) (aboutmebody) {
            I am married to Rebecca and together we have a 9-month-old son and a 40-year-old house in Aarhus Vest, which we are slowly renovating.
            Family, church, running and home improvement projects fill most of my spare time, although I also love reading, photography and board games.
        };
